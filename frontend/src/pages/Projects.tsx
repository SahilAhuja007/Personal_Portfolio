...
const featuredProjects = [
  {
    ...
    description:
      "Led development of the recruiter-side module in a college placement system used by students, faculty, and companies. Built scalable backend APIs and implemented real-time notifications.",
  ...
  },
  {
    title: "Vktut",
    description:
      "Developed a full-stack web application for personalized learning and assessment with role-based access control for students, teachers, and administrators.",
...
const allProjects = [
  ...featuredProjects,
  {
    title: "ResearchHub",
    description:
      "Built a full-stack platform for researchers to upload, organize, and manage academic papers with advanced search capabilities and collaborative features.",
  ...
  },
  {
    ...
    description:
      "Built a JEE/NEET-focused platform with syllabus tracking, quizzes, question papers, and dashboards for students preparing for competitive exams.",
